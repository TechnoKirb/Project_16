...
var knifeImage , fruit1, fruit2 ,fruit3,fruit4, monsterImage, gameOverImage, screech_of_pain, final_stand
...
function preload(){
  ...
  //load sound here
  screech_of_pain = loadSound('knifeSwoosh.mp3')
  final_stand = loadSound('gameover.mp3')
}
